    ...
    override val parameters = JsonSchema(
        properties = mapOf(
            "action" to JsonSchemaProperty(
                ...
                enumValues = listOf("dump_tree", "click", "long_click", "type", "scroll", "back", "home", "recents", "tap", "describe"),
            ),
            ...
            "direction" to JsonSchemaProperty("string", "scroll direction: forward or backward", enumValues = listOf("forward", "backward")),
